...
let beagle0 = new Dog("Snoopy");

Dog.prototype.numLegs = 4;

console.log(beagle0.numLegs);
...
let duck9 = new Bird("Donald");
duck9.hasOwnProperty("name");
...
let beagle10 = new Dog("Snoopy");

Dog.prototype.isPrototypeOf(beagle10); // yields true

// Fix the code below so that it evaluates to true
Dog.prototype.isPrototypeOf(beagle10);
...
let duck11 = Object.create(Animal.prototype); // Change this line
let beagle11 = Object.create(Animal.prototype); //
...
const pajarito = new Bird();

pajarito.weight; // undefined

pajarito.getWeight(); // 15
