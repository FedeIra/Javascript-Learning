...
printing(); // 1 4 3 2 . Esto pq el 3 y 2 van al callback queue mientras que el 1 y 4 no ya q van directo al execution. Entonces primero se ejecutan el 1 y el 4 y despues quedan los del callback queue. Primero se ejcuta el 3 porque tiene menos tiempo de espera y ultimo el 2. El settime out es una funcion de javascript.
